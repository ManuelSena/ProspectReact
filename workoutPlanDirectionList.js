...
//export const WorkoutPlanDirectionList: React.StatelessComponent<IWorkoutPlanGridViewOptions<IWorkoutPlanDirectionEntity>> = (props: IWorkoutPlanGridViewOptions<IWorkoutPlanDirectionEntity>) => {
//    return (
//        <React.Fragment>
...
//    )
//}
//const buildRow = (props: IWorkoutPlanGridViewOptions<IWorkoutPlanDirectionEntity>) => (itm: IWorkoutPlanDirectionEntity, ndx: number) => {
//    return (
//        <tbody key={ndx}>
//            <tr>
//                <td className="basis-20">{itm.stepName}</td>
//                <td className="basis-40">{itm.directions}</td>
//                <td className="basis-20">{itm.durationTypeId}</td>
//                <td className="basis-40">{itm.requirements}</td>
...
//    );
//}
//const buttonClick = (props: IWorkoutPlanGridViewOptions<IWorkoutPlanDirectionEntity>, id: number, action: string) => (e: React.SyntheticEvent<HTMLButtonElement>) => {
//    props.onButtonClick(id, action);
//} 
//# sourceMappingURL=workoutPlanDirectionList.js.map