...
export class PlanResultLog extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "col-md-12" },
            React.createElement(PlanResultLogPage, { planResultLogEntity: this.state.planResultLogEntity, onChange: this.onFieldChange, onSubmit: this.onSubmit }),
...
//# sourceMappingURL=PlanResultLogContainer.js.map